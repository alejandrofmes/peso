    ...
    <table class="m-6">
        ...
        <thead>
            <tr class="bg-blue-300 text-gray-600 text-left font-semibold text-sm">
                ...
                <th class="py-3 px-4 border-b w-1/4 text-center">Birth Date</th>
                <th class="py-3 px-4 border-b w-1/6 text-center">Gender</th>
                <th class="py-3 px-4 border-b w-1/6 text-center">Attainment</th>
                <th class="py-3 px-4 border-b w-1/12 text-center">Work Experience</th>
