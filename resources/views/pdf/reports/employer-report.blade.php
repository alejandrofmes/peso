    ...
    <table class="m-6">
        ...
        <thead>
            <tr class="bg-blue-300 text-gray-600 text-left font-semibold text-sm">
                <th class="py-3 px-4 border-b w-1/3">Company</th>
                <th class="py-3 px-4 border-b w-1/3">Contact Person</th>
                <th class="py-3 px-4 border-b w-1/6 text-center">Contact Number</th>
                <th class="py-3 px-4 border-b w-1/12 text-center">Job Postings</th>
                <th class="py-3 px-4 border-b w-1/12 text-center">Hired Applicants</th>
            </tr>
        </thead>
        <tbody>
