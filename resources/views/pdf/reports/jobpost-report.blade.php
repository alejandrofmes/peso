    ...
    <table class="m-6">
        ...
        <thead>
            <tr class="bg-blue-300 text-gray-600 text-left font-semibold text-sm">
                <th class="py-3 px-4 border-b w-1/3">Job Offering</th>
                <th class="py-3 px-4 border-b w-1/6">Type</th>
                <th class="py-3 px-4 border-b w-1/4 text-center">Date Posted</th>
                <th class="py-3 px-4 border-b w-1/12 text-center">Total Applicants</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($jobposts as $data)
                <tr class="border-b">
                    <td class="px-6 py-4 text-start font-normal text-gray-700 uppercase">

                        <div class="text-base font-semibold"> {{ $data['jobTitle'] }}</div>
                        <div class="text-xs font-normal text-gray-500 uppercase">
                            {{ $data['companyName'] }}
                        </div>
                    </td>
                    <td class="px-4 py-4 text-start font-normal text-gray-500 text-sm uppercase">
                        {{ $data['empType'] }}
                    </td>
