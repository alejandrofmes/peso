<div wire:poll.5s class="container mx-auto py-8">
                                        ...
                                        <tr wire:key="{{ $data->cert_type_id }}"
                                            ...
                                            <td class="px-6 py-4">
                                                ...
                                                <div class="flex flex-row items-center justify-center gap-6">
                                                    ...
                                                    @if ($data->cert_Status == 1)
                                                        <div x-data="{ tooltip: 'Archive Certificate' }">
                                                            <button x-tooltip="tooltip" type="button"
                                                                wire:click.prevent="archiveConfirmation({{ $data->cert_type_id }})"
                                                    ...
                                                    @if ($data->cert_Status == 2)
                                                        <div x-data="{ tooltip: 'Restore Certificate' }">
                                                            <button x-tooltip="tooltip" type="button"
                                                                wire:click.prevent="restoreConfirmation({{ $data->cert_type_id }})"
    ...
    <x-modal name="delete-cert-modal" focusable>
        <div class="w-full max-w-4xl px-6 py-6 items-center">
            ...
            <div class="flex flex-col justify-center items-center my-12">
                ...
                <h1 class="text-2xl font-bold">Are you sure you want to archive this certificate?</h1>
            ...
            <div class="mt-6 flex justify-end">
                ...
                <x-danger-button wire:loading.attr="disabled" wire:click.prevent="confirmArchive()" class="ms-3"
                    type="button">
                    {{ __('Confirm') }}
    ...
    <x-modal name="restore-cert-modal" focusable>
        <div class="w-full max-w-4xl px-6 py-6 items-center">
            <h2 class="text-lg font-medium text-gray-900">
                {{ __('Action Confirmation') }}
            </h2>
            ...
            <div class="flex flex-col justify-center items-center my-12">
                ...
                <h1 class="text-2xl font-bold">Are you sure you want to restore this certificate?</h1>


            </div>
            <div class="mt-6 flex justify-end">
                <x-secondary-button x-on:click="$dispatch('close-modal', 'restore-cert-modal')">
                    {{ __('Cancel') }}
                </x-secondary-button>

                <x-green-button wire:loading.attr="disabled" wire:click.prevent="confirmRestore()" class="ms-3"
                    type="button">
                    {{ __('Confirm') }}
