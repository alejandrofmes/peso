                        ...
                        <div
                            ...
                            @if ($announcementImage && !$errors->has('announcementImage'))
                                <img id="uploadedImage"
                                    ...
                                    src="{{ $announcementImage->temporaryUrl() }}" alt="pubmat" />
                            @else
                                <img id="uploadedImage"
                                    class="flex w-full-h-full uploaded-image object-cover shrink-0 grow-0"
                                    src="{{ asset('storage/' . $announcementInfo->announcement_pubmat) }}"
                                    alt="pubmat" />
                            @endif
    ...
    <x-modal name="confirm-modal" focusable>
        <div class="w-full max-w-4xl px-6 py-6 items-center">
            ...
            <div class="flex flex-col justify-center items-center my-12">
                ...
                <h1 class="text-2xl font-bold">Are you sure you want to update this announcement?</h1>
