    ...
    <div class="grid grid-cols-4 gap-4 p-3 lg:grid-cols-12 lg:p-0" x-data="{ selectedAnalytics: @entangle('selectedAnalytics') }">
                            ...
                            <x-slot name="content">
                                ...
                                <div class="max-h-[300px] bg-white overflow-y-auto">
                                    ...
                                    @foreach ($municipalities as $data)
                                        <x-dropdown-link wire:click.prevent='munSelect({{ $data->municipality_id }})'
        ...
        <div class="col-span-4 md:col-span-6">
            <div class="w-full h-full p-6 overflow-auto bg-white rounded-lg shadow">
                <livewire:admin.reports.municipality-partials.jobseekers-list municipalityID="{{ $selectedMun }}" />
            </div>
        </div>

        <div class="col-span-4 md:col-span-6">

            <livewire:admin.reports.municipality-partials.popular-trainings municipalityID="{{ $selectedMun }}" />


            <livewire:admin.reports.municipality-partials.top-tags-programs municipalityID="{{ $selectedMun }}" />
