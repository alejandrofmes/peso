    ...
    <div class="grid grid-cols-4 lg:grid-cols-12 gap-4 p-3 lg:p-0" x-data="{ selectedAnalytics: @entangle('selectedAnalytics') }">
        ...
        <div class="col-span-2 md:col-span-3">
            <div class="bg-blue-100 shadow rounded-lg p-6 flex flex-col h-full">
                ...
                <div class="flex flex-row w-full justify-between mb-5 mt-auto gap-5">
                    <div class="flex flex-col w-full">
                        <x-dropdown align="left" width="full">
                            ...
                            <x-slot name="content">
                                <!-- Search input -->
                                <div class="p-2">
                                    <input wire:model.live='searchProv' type="search" placeholder="Search..."
                    ...
                    <svg class="hidden sm:flex w-10 h-10 text-blue-500" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="col-span-2 md:col-span-3">
            <div class="flex flex-col h-full p-6 bg-blue-100 rounded-lg shadow">
                ...
                <div class="flex flex-row justify-between w-full gap-5 mt-auto mb-5">
                    ...
                    <svg class="hidden w-12 h-12 text-blue-500 lg:flex" xmlns="http://www.w3.org/2000/svg"
                        fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M10.5 6a7.5 7.5 0 1 0 7.5 7.5h-7.5V6Z" />
                        <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="col-span-2 lg:col-span-3">
            <div class="bg-white shadow rounded-lg p-6 flex flex-col w-full h-full">
                ...
                <div class="flex flex-row justify-between mb-5">
                    ...
                    <svg class="hidden lg:flex w-10 h-10 text-blue-500" xmlns="http://www.w3.org/2000/svg"
                        fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            @if ($selectedAnalytics === 1)
                <div class="flex flex-col w-full gap-4 md:flex-row">
                    <div class="flex w-full">
                        <livewire:admin.super.reports.province-partials.municipality-jobseekers
        ...
        <div class="col-span-4 md:col-span-6">
            <div class="w-full h-full p-6 overflow-auto bg-white rounded-lg shadow">
                <livewire:admin.reports.municipality-partials.jobseekers-list provinceID="{{ $selectedProv }}" />
            </div>
        </div>

        <div class="col-span-4 md:col-span-6">

            <livewire:admin.reports.municipality-partials.popular-trainings provinceID="{{ $selectedProv }}" />
