<div class="flex flex-col w-full h-full" x-data="{ agreeBox: @entangle('agreeBox') }">
    ...
    <div class="flex flex-col items-center justify-center w-full px-4 mt-10 lg:px-12">
        <p class="text-sm text-justify lg:text-xl">
            ...
            employment. This includes potential employers, recruiters, and relevant administrative personnel involved in
            the operation of the platform. Please ensure that all details provided are genuine and up-to-date, as any
            false
            or misleading information may adversely affect your eligibility for job opportunities and could potentially
            impact your reputation within the system. Your cooperation and honesty in providing accurate information are
            crucial for maintaining the integrity and effectiveness of the job hiring process facilitated through this
            platform.
        </p>
        <div class="inline-flex items-center">
            <label class="relative flex items-center p-3 rounded-full cursor-pointer" for="agreeBox">
                <input wire:model="agreeBox" type="checkbox"
                    class="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-md border border-blue-gray-200 transition-all before:absolute before:top-2/4 before:left-2/4 before:block before:h-12 before:w-12 before:-translate-y-2/4 before:-translate-x-2/4 before:rounded-full before:bg-blue-gray-500 before:opacity-0 before:transition-opacity checked:border-blue-900 checked:bg-blue-600 checked:before:bg-gray-900 hover:before:opacity-10"
                    id="agreeBox" />
                <span
    ...
    <div class="flex flex-row justify-between mt-4 space-x-4 lg:mt-auto lg:mb-4">
        ...
        <x-green-button wire:loading.attr='disabled' wire:click.prevent='save' x-show="agreeBox">
            ...
            <div wire:loading.delay.long role="status">
                <svg aria-hidden="true" class="w-5 h-5 ml-4 text-gray-200 animate-spin fill-blue-600"
                    viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z"
                        fill="currentColor" />
