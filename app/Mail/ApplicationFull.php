...
class ApplicationFull extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Job Application Update: Position Has Been Filled',
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.application_full_notification',
            with: [
