...
class PartnershipNotification extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Update on Your Partnership Application with PESO',
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.partnership_notification',
            with: [
                'companyName' => $this->partnershipData->company->business_Name,
                'applicationStatus' => $this->partnershipData->partnership_Status,
