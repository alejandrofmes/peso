...
class JobApplicationExpiredNotification extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Your Application for Has Been Rejected',
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.job_application_expired_notification',
            with: [
