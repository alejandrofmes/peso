...
class JobPostApplicationNotification extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Update on Your Job Posting Request Status',
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.job_post_application_notification',
            with: [
